...
```bash
$ cortex install easing-functions --save
```
...
```js
var easing_functions = require('easing-functions');
```
...
### Class: easing_functions(options)
<!-- 
...
Creates a new easing-functions instance.
...
### easing-functions.&lt;method-name&gt;(arguments)
